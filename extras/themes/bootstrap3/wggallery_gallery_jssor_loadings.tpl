...
<{if $jssor_loadings|default:'' == 'loading-003-oval'}>
        ...
        <div data-u="loading" class="jssorl-003-oval" style="position:absolute;top:0;left:0;width:100%;height:100%;text-align:center;background-color:rgba(0,0,0,0.7);">
            <img alt="image" style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;" src="<{$wggallery_url}>/assets/gallerytypes/jssor/svg/loading/static-svg/oval.svg">
        </div>	
<{/if}>
...
<{if $jssor_loadings|default:'' == 'loading-004-double-tail-spin'}>
		...
		<div data-u="loading" class="jssorl-004-double-tail-spin" style="position:absolute;top:0;left:0;width:100%;height:100%;text-align:center;background-color:rgba(0,0,0,0.7);">
            <img alt="image" style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;" src="<{$wggallery_url}>/assets/gallerytypes/jssor/svg/loading/static-svg/double-tail-spin.svg">
        </div>		
<{/if}>
...
<{if $jssor_loadings|default:'' == 'loading-005-circles'}>
		...
		<div data-u="loading" class="jssorl-005-circles" style="position:absolute;top:0;left:0;width:100%;height:100%;text-align:center;background-color:rgba(0,0,0,0.7);">
            <img alt="image" style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;" src="<{$wggallery_url}>/assets/gallerytypes/jssor/svg/loading/static-svg/circles.svg">
        </div>
<{/if}>
...
<{if $jssor_loadings|default:'' == 'loading-006-tail-spin'}>
		...
		<div data-u="loading" class="jssorl-006-tail-spin" style="position:absolute;top:0;left:0;width:100%;height:100%;text-align:center;background-color:rgba(0,0,0,0.7);">
            <img alt="image" style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;" src="<{$wggallery_url}>/assets/gallerytypes/jssor/svg/loading/static-svg/tail-spin.svg">
        </div>
<{/if}>
...
<{if $jssor_loadings|default:'' == 'loading-008-ball-triangle'}>
		...
		<div data-u="loading" class="jssorl-008-ball-triangle" style="position:absolute;top:0;left:0;width:100%;height:100%;text-align:center;background-color:rgba(0,0,0,0.7);">
            <img alt="image" style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;" src="<{$wggallery_url}>/assets/gallerytypes/jssor/svg/loading/static-svg/ball-triangle.svg">
        </div>
<{/if}>
...
<{if $jssor_loadings|default:'' == 'loading-009-spin'}>
		...
		<div data-u="loading" class="jssorl-009-spin" style="position:absolute;top:0;left:0;width:100%;height:100%;text-align:center;background-color:rgba(0,0,0,0.7);">
            <img alt="image" style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;" src="<{$wggallery_url}>/assets/gallerytypes/jssor/svg/loading/static-svg/spin.svg">
        </div>
<{/if}>
