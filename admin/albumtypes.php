...
switch ($op) {
    ...
    case 'saveoptions':
        ...
        if (isset($_POST['number_cols_album'])) {
            $options[] = ['name' => 'number_cols_album', 'value' => $_POST['number_cols_album'], 'caption' => '_AM_WGGALLERY_OPTION_AT_NB_COLS_ALB'];
        }
        if (isset($_POST['number_cols_cat'])) {
            $options[] = ['name' => 'number_cols_cat', 'value' => $_POST['number_cols_cat'], 'caption' => '_AM_WGGALLERY_OPTION_AT_NB_COLS_CAT'];
        }
        if (isset($_POST['hovereffect'])) {
            $options[] = ['name' => 'hovereffect', 'value' => $_POST['hovereffect'], 'caption' => '_AM_WGGALLERY_OPTION_AT_HOVER'];
        }
        ...
        if (isset($_POST['showDesc'])) {
            $options[] = ['name' => 'showDesc', 'value' => $_POST['showDesc'], 'caption' => '_AM_WGGALLERY_OPTION_SHOWDESCR'];
        }
        if (isset($_POST['album_showsubmitter'])) {
            $options[] = ['name' => 'album_showsubmitter', 'value' => $_POST['album_showsubmitter'], 'caption' => '_AM_WGGALLERY_OPTION_SHOWSUBMITTER'];
        }
